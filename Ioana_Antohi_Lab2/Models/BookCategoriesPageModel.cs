...
namespace Ioana_Antohi_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Ioana_Antohi_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Ioana_Antohi_Lab2Context context,
